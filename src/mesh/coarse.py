...
class Coarse(nn.Module):
    def __init__(self, n, kernel=7, sigma=1, r=0.5, ch=32):
        ...
        self.radii = torch.nn.Parameter(torch.rand(6, 3, n, n) -0.5)
    ...
    def forward(self):        
        ...
        abc = torch.sigmoid(self.abc) 
        stacked = self.get_ellipsoidal(radii, abc)
        vert = to_vertices(stacked)
        return vert, self.faces, self.radii, stacked
